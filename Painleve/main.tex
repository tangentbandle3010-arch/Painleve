...
\input{sections/02_fuchs.tex}
\section{パンルヴェ方程式の基礎}
\subsection{変形微分方程式系}
\input{sections/03_パンルヴェ方程式の基礎/0301_変形微分方程式系.tex}
\subsection{2階フックス型微分方程式のラックス方程式}
\input{sections/03_パンルヴェ方程式の基礎/0302_2階フックス型微分方程式のラックス方程式.tex}
\subsection{変形微分方程式系の解}
\input{sections/03_パンルヴェ方程式の基礎/0303_変形微分方程式系の解.tex}
\subsection{シュレージンガー系}
\input{sections/03_パンルヴェ方程式の基礎/0304_シュレージンガー系.tex}
\subsection{ガルニエ系}
\input{sections/03_パンルヴェ方程式の基礎/0305_ガルニエ系.tex}
\subsection{ガルニエ系のハミルトン表示}
\input{sections/03_パンルヴェ方程式の基礎/0306_ガルニエ系のハミルトン表示.tex}
\appendix
